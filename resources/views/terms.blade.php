        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 backdrop-blur-sm">
                <div class="p-8 md:p-12">
                                ...
                                <table class="min-w-full">
                                    <thead>
                                        <tr class="bg-gradient-to-r from-green-500 to-emerald-500 text-white">
                                            <th class="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider">{{ __('tipo_envio') }}</th>
                                            <th class="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider">{{ __('tiempo_entrega') }}</th>
                                            <th class="px-6 py-4 text-left text-sm font-bold uppercase tracking-wider">{{ __('costo') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class="bg-white border-b border-gray-200 hover:bg-green-50 transition-colors">
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-700 font-medium">{{ __('envio_estandar') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-700">{{ __('tiempo_estandar') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-700">{{ __('costo_estandar') }}</td>
                                        </tr>
                                        <tr class="bg-gray-50 border-b border-gray-200 hover:bg-green-50 transition-colors">
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-700 font-medium">{{ __('envio_express') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-700">{{ __('tiempo_express') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-700">{{ __('costo_express') }}</td>
                                        </tr>
                                        <tr class="bg-white hover:bg-green-50 transition-colors">
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-700 font-medium">{{ __('envio_premium') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-700">{{ __('tiempo_premium') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-700">{{ __('costo_premium') }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <!-- 8. Devoluciones y reembolsos Premium -->
                    <div class="mb-12 relative">
                    ...
                    <!-- 9. Propiedad intelectual Premium -->
                    <div class="mb-12 relative">
                    ...
                    <!-- 10. Privacidad y datos personales Premium -->
                    <div class="mb-12 relative">
                    ...
                    <!-- 11. Limitación de responsabilidad Premium -->
                    <div class="mb-12 relative">
                    ...
                    <!-- 13. Legislación aplicable Premium -->
                    <div class="mb-12 relative">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-4">
                                        <div class="flex items-start">
                                            ...
                                            <span class="text-gray-700">{{ __('email') }}: <a href="mailto:{{ __('email_contacto') }}" class="text-blue-600 hover:text-blue-800 transition-colors font-medium">{{ __('email_contacto') }}</a></span>
                                        </div>
                                        <div class="flex items-start">
                                            <i class="fas fa-phone-alt text-blue-600 mt-1 mr-3 text-lg"></i>
                                            <span class="text-gray-700">{{ __('telefono') }}: {{ __('telefono_contacto') }}</span>
                                        </div>
                                        <div class="flex items-start">
                                            <i class="fas fa-map-marker-alt text-blue-600 mt-1 mr-3 text-lg"></i>
                                            <span class="text-gray-700">{{ __('direccion') }}: {{ __('direccion_contacto') }}</span>
                                        </div>
                                    </div>
