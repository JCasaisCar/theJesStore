        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 backdrop-blur-sm">
                <div class="p-8 md:p-12">
                    ...
                    <!-- Cookies que utilizamos Premium -->
                    <div class="mb-12 relative">
                                ...
                                <table class="min-w-full">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr class="hover:bg-purple-50 transition-colors">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">thejesstore.com</td>
                                            <td class="px-6 py-4 text-sm text-gray-700">{{ __('sesion_usuario') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ __('sesion') }}</td>
                                        </tr>
                                        <tr class="hover:bg-purple-50 transition-colors">
                                        ...
                                        <tr class="hover:bg-purple-50 transition-colors">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">_ga</td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">2 {{ __('anos') }}</td>
                                        </tr>
                                        <tr class="hover:bg-purple-50 transition-colors">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">_gid</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">Google</td>
                                            <td class="px-6 py-4 text-sm text-gray-700">{{ __('analitica') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">24 {{ __('horas') }}</td>
                                        </tr>
                                        <tr class="hover:bg-purple-50 transition-colors">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">_fbp</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">Facebook</td>
                                            <td class="px-6 py-4 text-sm text-gray-700">{{ __('marketing') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">3 {{ __('meses') }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="mb-12 relative">
                        ...
                        <div class="flex items-start gap-4 mb-6">
                            ...
                            <h2 class="text-3xl font-black text-gray-900 flex-1">{{ __('control_cookies') }}</h2>
                        </div>
                        <div class="ml-16">
                            <p class="text-gray-700 leading-relaxed text-lg mb-6">{{ __('control_cookies_p1') }}</p>
                            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-6 rounded-2xl mb-6">
                                <div class="flex">
                                    <div class="flex-shrink-0">
                                        <i class="fas fa-info-circle text-blue-500 text-xl"></i>
                                    </div>
                                    <div class="ml-3">
                                        <p class="text-blue-700 leading-relaxed">{{ __('control_cookies_info') }}</p>
                                    </div>
                                </div>
                            </div>
                            <p class="text-gray-700 leading-relaxed text-lg">{{ __('control_cookies_p2') }}</p>
                        </div>
                    </div>

                    <!-- Ajustes de cookies Premium -->
                    <div class="mb-12 relative">
                        ...
                        <div class="flex items-start gap-4 mb-6">
                            ...
                            <h2 class="text-3xl font-black text-gray-900 flex-1">{{ __('ajustes_cookies') }}</h2>
                        </div>
                        <div class="ml-16">
                            <div class="bg-gradient-to-br from-gray-50 to-gray-100 p-8 rounded-3xl border border-gray-200 shadow-lg">
                                <div class="space-y-6">
                                    <div class="flex items-center justify-between p-4 bg-white rounded-2xl shadow">
                                        <div>
                                            <p class="font-bold text-gray-800 text-lg">{{ __('cookies_necesarias') }}</p>
                                            <p class="text-gray-600">{{ __('no_desactivar') }}</p>
                                        </div>
                                        <div class="bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-sm font-bold px-4 py-2 rounded-xl shadow">
                                            {{ __('obligatorias') }}
                                        </div>
                                    </div>
                                    <div class="flex items-center justify-between p-4 bg-white rounded-2xl shadow">
                                        <div class="flex-1">
                                            <p class="font-bold text-gray-800 text-lg">{{ __('cookies_preferencias') }}</p>
                                            <p class="text-gray-600">{{ __('mejorar_experiencia') }}</p>
                                        </div>
                                    ...
                                    <div class="flex items-center justify-between p-4 bg-white rounded-2xl shadow">
                                        <div class="flex-1">
                                            <p class="font-bold text-gray-800 text-lg">{{ __('cookies_estadisticas') }}</p>
                                            <p class="text-gray-600">{{ __('analizar_uso') }}</p>
                                        </div>
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" class="sr-only peer" checked>
                                            <div class="w-14 h-7 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-gradient-to-r peer-checked:from-blue-500 peer-checked:to-cyan-500"></div>
                                    ...
                                    <div class="flex items-center justify-between p-4 bg-white rounded-2xl shadow">
                                        <div class="flex-1">
                                            <p class="font-bold text-gray-800 text-lg">{{ __('cookies_marketing') }}</p>
                                            <p class="text-gray-600">{{ __('mostrar_publicidad') }}</p>
                                        </div>
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" class="sr-only peer" checked>
                                            <div class="w-14 h-7 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-gradient-to-r peer-checked:from-blue-500 peer-checked:to-cyan-500"></div>
                                ...
                                <div class="mt-8 text-center">
                                    <button type="button" class="group inline-flex items-center bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl focus:ring-4 focus:ring-blue-500/20">
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <span class="text-gray-700">{{ __('email') }}: cookies@thejesstore.com</span>
                                            </div>
                                            <div class="flex items-center gap-3">
                                                <i class="fas fa-phone text-indigo-600"></i>
                                                <span class="text-gray-700">{{ __('telefono') }}: +34 612 345 678</span>
                                            </div>
                                            <div class="flex items-center gap-3">
                                                <i class="fas fa-map-marker-alt text-indigo-600"></i>
                                                <span class="text-gray-700">{{ __('direccion') }}: Sevilla, España</span>
                                            </div>
                                        </div>
                                    </div>
