...
@section('content')
<body id="admin-page">
<!-- Header Premium del Panel de Administración -->
...
<div class="bg-gradient-to-br from-gray-50 via-white to-gray-50 py-16">
    <div class="container mx-auto px-6">
                ...
                <div class="flex justify-between items-start">
                    <div class="flex-1">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <p class="text-sm text-green-600 font-medium">{{ $totalPedidos }} ventas</p>
                        </div>
                    </div>
        ...
        <!-- Gráficos y Actividad Reciente Premium -->
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-16">
            <!-- Gráfico de Ventas Premium -->
            ...
            <!-- Productos con stock bajo Premium -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-16">
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100 backdrop-blur-sm">
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <h2 class="text-2xl font-black text-gray-900">Mensajes recientes</h2>
                </div>
                        ...
                        <div class="bg-gradient-to-br from-gray-50 to-white p-6 rounded-2xl border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-300">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 font-medium mb-3">Asunto: {{ $contacto->asunto }}</p>
                                    <button 
        ...
        <!-- Cupones y Newsletter Premium -->
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-16">
            <!-- Cupones de Descuento Premium -->
            <div class="group bg-white rounded-3xl shadow-2xl p-8 border border-gray-100 backdrop-blur-sm hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2">
                <div class="flex justify-between items-start">
                    <div class="flex-1">
                        <div class="w-1 h-16 bg-gradient-to-b from-green-500 to-emerald-500 rounded-full mb-4"></div>
                        <p class="text-gray-500 text-sm font-medium">Cupones Activos</p>
                        ...
                        <div class="flex items-center gap-2 mb-4">
                            ...
                            <p class="text-sm text-red-600 font-medium">Inactivos: {{ $cuponesInactivos }}</p>
                        </div>
            ...
            <!-- Suscriptores Newsletter Premium -->
            <div class="group bg-white rounded-3xl shadow-2xl p-8 border border-gray-100 backdrop-blur-sm hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2">
                <div class="flex justify-between items-start">
                    <div class="flex-1">
                        <div class="w-1 h-16 bg-gradient-to-b from-indigo-500 to-purple-500 rounded-full mb-4"></div>
                        <p class="text-gray-500 text-sm font-medium">Suscriptores Newsletter</p>
...
<!-- Modal Premium para responder mensajes -->
            ...
            <form method="POST" action="{{ route('contact.answer') }}">
                ...
                <div class="bg-gradient-to-br from-gray-50 via-white to-gray-50 rounded-2xl p-6 mb-8 border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="group">
                            <label class="text-sm font-medium text-gray-500 mb-1 block">Nombre</label>
                        ...
                        <div class="group">
                            <label class="text-sm font-medium text-gray-500 mb-1 block">Teléfono</label>
                        ...
                        <div class="group">
                            <label class="text-sm font-medium text-gray-500 mb-1 block">Fecha</label>
                ...
                <div class="bg-gradient-to-br from-blue-50 via-white to-cyan-50 rounded-2xl p-6 mb-8 border border-blue-100">
                    ...
                    <div class="space-y-4">
                        <div class="group">
                            <label class="text-sm font-medium text-gray-500 mb-2 block">Asunto</label>
                        ...
                        <div class="group">
                            <label class="text-sm font-medium text-gray-500 mb-2 block">Mensaje</label>
                ...
                <div class="bg-gradient-to-br from-green-50 via-white to-emerald-50 rounded-2xl p-6 border border-green-100">
                    ...
                    <div class="relative">
                        <textarea 
                            ...
                            placeholder="Escribe tu respuesta aquí... Sé claro, profesional y útil en tu comunicación."
                            required
                        ></textarea>
                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
                                ...
                                <th class="px-6 py-4 text-left text-xs font-bold text-gray-600 uppercase tracking-wider">Tracking</th>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-bold text-gray-600 uppercase tracking-wider">Acción</th>
                                <th class="px-6 py-4 text-left text-xs font-bold text-gray-600 uppercase tracking-wider">Detalles</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($ultimosPedidos as $pedido)
                                                ...
                                                <table class="w-full text-sm">
                                                    <thead>
                                                        <tr class="bg-gradient-to-r from-gray-100 to-gray-200 rounded-xl">
                                                            <th class="px-4 py-3 text-left text-xs font-bold text-gray-600 uppercase">Imagen</th>
                                                            <th class="px-4 py-3 text-left text-xs font-bold text-gray-600 uppercase">Producto</th>
                                                            <th class="px-4 py-3 text-left text-xs font-bold text-gray-600 uppercase">Cantidad</th>
