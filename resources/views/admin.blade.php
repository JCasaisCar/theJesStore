...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-md p-6">
            ...
            <div class="h-64 flex items-center justify-center">
                <!-- Aquí iría el gráfico con Javascript -->
    ...
    <!-- Pedidos Recientes y Mensajes de Contacto -->
                ...
                <table class="min-w-full">
                    <thead>
                        <tr class="border-b border-gray-200">
                            <th class="py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ID</th>
                            <th class="py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('admin.cliente') }}</th>
                            <th class="py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('admin.estado') }}</th>
                            <th class="py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('admin.total') }}</th>
                            <th class="py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('admin.fecha') }}</th>
