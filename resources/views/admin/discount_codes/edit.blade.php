    ...
    <div class="container mx-auto px-4 py-20 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <h1 class="text-4xl md:text-6xl font-black mb-6 bg-gradient-to-r from-white via-yellow-200 to-yellow-300 bg-clip-text text-transparent animate__animated animate__fadeInUp">
                Editar <span class="bg-gradient-to-r from-yellow-300 to-yellow-500 bg-clip-text text-transparent">Código</span>
            </h1>
    ...
    <div class="container mx-auto px-4 max-w-2xl">
        <div class="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-100">
            ...
            <form method="POST" action="{{ route('discount_codes.update', $discountCode) }}" class="space-y-6">
                ...
                <!-- Porcentaje -->
                <div class="group">
                    <label class="block text-sm font-bold text-gray-700 mb-2">% Descuento *</label>
                ...
                <!-- Expiración -->
                <div class="group">
                    <label class="block text-sm font-bold text-gray-700 mb-2">Fecha de Expiración</label>
                ...
                <!-- Usuarios -->
                <div class="group">
                    <label class="block text-sm font-bold text-gray-700 mb-2">Usuarios asignados</label>
