        ...
        <div class="max-w-6xl mx-auto">
            @if ($orders->isEmpty())
                ...
                <div class="bg-white rounded-3xl shadow-2xl p-12 text-center border border-gray-100">
                    ...
                    <h3 class="text-3xl font-black text-gray-800 mb-4">No tienes pedidos registrados</h3>
                    <p class="text-lg text-gray-600 mb-8 max-w-md mx-auto">
                        Empieza a comprar y aquí aparecerán todos tus pedidos
                    </p>
                                ...
                                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                    <div class="flex-1">
                                        <div class="flex items-center gap-3 mb-3">
                                            ...
                                            <h3 class="text-2xl font-black text-gray-800">Pedido #{{ $order->id }}</h3>
                                        </div>
                                    ...
                                    <button onclick="toggleDetails({{ $order->id }})" 
                                        ...
                                        <span id="toggle-text-{{ $order->id }}">Ver detalles</span>
                            ...
                            <div id="order-details-{{ $order->id }}" class="hidden border-t border-gray-100">
                                <div class="p-6 md:p-8">
                                        ...
                                        <table class="w-full">
                                            <thead>
                                                <tr class="bg-gradient-to-r from-gray-50 to-gray-100 text-gray-700">
                                                    ...
                                                    <th class="px-6 py-4 text-center text-sm font-bold uppercase tracking-wider">Cantidad</th>
                                                    <th class="px-6 py-4 text-right text-sm font-bold uppercase tracking-wider">Precio</th>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                ...
                                                <div class="space-y-3">
                                                    ...
                                                    @if ($descuento > 0)
                                                        <div class="flex justify-between items-center">
                                                            <span class="text-green-700 font-medium">Descuento:</span>
                                    ...
                                    <div class="mt-6 flex flex-wrap gap-3 justify-end">
                                        @if($order->tracking)
                                            <button class="group inline-flex items-center bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105">
                                                <i class="fas fa-truck mr-2"></i>
                                                Seguir envío
                                            </button>
                                        @endif
                                        <button class="group inline-flex items-center bg-white hover:bg-gray-50 text-gray-700 font-bold py-3 px-6 rounded-xl transition-all duration-300 border-2 border-gray-200">
