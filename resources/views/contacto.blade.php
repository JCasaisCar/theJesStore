...
<!-- Información de Contacto y Formulario Premium -->
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
            ...
            <div class="relative w-full h-96 bg-gradient-to-br from-gray-100 to-gray-200">
                <div class="absolute inset-0 flex flex-col items-center justify-center">
                    <div class="w-24 h-24 bg-gradient-to-br from-blue-500 to-purple-500 rounded-3xl flex items-center justify-center mb-4 shadow-2xl animate-bounce-slow">
                        <i class="fas fa-map-marked-alt text-white text-3xl"></i>
                    </div>
                    <p class="text-gray-600 font-medium">{{ __('mapa_aqui') }}</p>
                </div>
                <!-- 
...
<!-- Modal para ver mensajes Premium -->
