...
<nav class="bg-gray-100 border-b border-gray-200 shadow-sm py-1">
  <div class="container mx-auto px-4">
    ...
    <div class="hidden md:flex flex-wrap justify-center gap-8 text-sm text-gray-700">
      <a href="{{ route('categoria', 'smartphones') }}" class="py-2 border-b-2 border-transparent hover:border-blue-500 hover:text-blue-600 transition-all font-medium">{{ __('smartphones') }}</a>
      <a href="{{ route('categoria', 'accesorios') }}" class="py-2 border-b-2 border-transparent hover:border-blue-500 hover:text-blue-600 transition-all font-medium">{{ __('accesorios') }}</a>
      <a href="{{ route('categoria', 'tablets') }}" class="py-2 border-b-2 border-transparent hover:border-blue-500 hover:text-blue-600 transition-all font-medium">{{ __('tablets') }}</a>
    </div>
    ...
    <div class="md:hidden">
      ...
      <div id="categories-menu" class="hidden bg-white rounded-b-lg shadow-lg mt-1 py-2">
        <a href="{{ route('categoria', 'smartphones') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">{{ __('smartphones') }}</a>
        <a href="{{ route('categoria', 'accesorios') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">{{ __('accesorios') }}</a>
        <a href="{{ route('categoria', 'tablets') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">{{ __('tablets') }}</a>
      </div>
    </div>
  </div>
</nav>
...
<script>
  ...
  // Categories dropdown toggle for mobile
